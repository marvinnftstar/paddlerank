    ...
    <main className="min-h-screen bg-court-mist text-slate-950">
      ...
      <section className="px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[0.7fr_1.3fr]">
          <aside className="rounded-3xl border border-court-teal/15 bg-white p-4 shadow-sm sm:p-6">
          ...
          <section className="rounded-3xl border border-court-teal/15 bg-white p-4 shadow-glow sm:p-6 lg:p-7">
            ...
            <form action={saveProfile} className="mt-5 grid gap-5 sm:mt-6 sm:grid-cols-2">
              <label>
